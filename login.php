...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $chk = $pdo->query("SELECT * FROM `users` WHERE `username`='$username' AND `password`='$password'")->fetch();
...
<form method="POST" action="login.php" class="login-form form-group w-50 m-auto">
    ...
    <div class="my-2 text-center">
        <button type="submit" class="login-submit-button btn btn-primary btn-lg">登入</button>
    </div>
