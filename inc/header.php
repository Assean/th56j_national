<header class="site-header">
    ...
    <div class="user-area d-flex justify-content-end">
        <?php if(!isset($_SESSION['user'])){ ?>
            <a href="login.php" class="login-link btn btn-success p-2 m-2">登入</a>
            <a href="register.php" class="register-link btn btn-success p-2 m-2">註冊</a>
            <?php }else{ ?>
            <a href="profile.php" class="profile-link btn btn-success p-2 m-2">個人頁面入口</a>
            <a href="api/logout.php" class="logout-link btn btn-success p-2 m-2">登出</a>
        <?php } ?>
    </div>
</header>